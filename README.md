...
> Answer:Faster load speed; no white screen intermission when moving between pages;
...
> Answer: Controlled components  are controlled data that are handled by a react component versus the DOM
